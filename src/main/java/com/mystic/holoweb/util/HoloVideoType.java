package com.mystic.holoweb.util;
...
public enum HoloVideoType {
    ...
    HoloVideoType(String prefix, String suffix) {
        volumePrefix = prefix;
        volumeSuffix = suffix;
    ...
    @Nullable
    public static HoloVideoType getTypeFromURL(@Nonnull URL url) {
    ...
    @Nullable
    public static HoloVideoType getTypeFromURL(@Nonnull String url) {
        try {
